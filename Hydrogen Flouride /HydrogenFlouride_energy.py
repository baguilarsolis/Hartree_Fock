...
nuc_rep = np.loadtxt("/Users/briannaaguilar-solis/python_virt_envs/my_first_venv/HF_hf/integral_hf/hf_sto3g_nuc.txt")
#print("Nuclear Repulsion Energy: ", nuc_rep,'\n')

# Read in overlap matrix

S = np.loadtxt("/Users/briannaaguilar-solis/python_virt_envs/my_first_venv/HF_hf/integral_hf/hf_sto3g_ovl.txt")
#print("Overlap Matrix: ",'\n',S, '\n')

# Read in one electron integral

h_core = np.loadtxt("/Users/briannaaguilar-solis/python_virt_envs/my_first_venv/HF_hf/integral_hf/hf_sto3g_oei.txt")
#print("H(core): ",'\n',h_core, '\n')

# Read in two electron integral

tei = np.zeros([6,6,6,6])
with open("/Users/briannaaguilar-solis/python_virt_envs/my_first_venv/HF_hf/integral_hf/hf_sto3g_tei.txt",'r') as f:
  for line in f:
    w = line.split()
